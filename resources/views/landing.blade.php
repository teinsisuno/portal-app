...
<body class="bg-white text-slate-700 font-landing antialiased">
    ...
    <header class="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-slate-100">
        <nav class="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
            <a href="#beranda" class="flex items-center gap-2">
                <span class="w-8 h-8 rounded-lg bg-blue-600 text-white flex items-center justify-center text-lg font-extrabold">M</span>
                <span class="font-extrabold text-slate-800 text-lg">megakomsel<span class="text-blue-600">.com</span></span>
            </a>
            <div class="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                <a href="#aplikasi" class="hover:text-blue-600 transition">Aplikasi</a>
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('login') }}" class="text-sm font-semibold text-slate-600 hover:text-blue-600 transition px-3 py-2">Masuk</a>
                <a href="{{ route('register') }}" class="text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 transition px-4 py-2 rounded-lg shadow-sm shadow-blue-600/20">Daftar Gratis</a>
            </div>
        </nav>
    </header>

    {{-- ================= HERO ================= --}}
    <section id="beranda" class="relative overflow-hidden bg-gradient-to-b from-blue-600 via-blue-600 to-indigo-700 text-white">
        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 pt-20 pb-24 text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('register') }}" class="w-full sm:w-auto bg-white text-blue-700 font-bold px-8 py-3.5 rounded-xl hover:bg-blue-50 transition shadow-lg">
            ...
            <div class="mt-14 grid grid-cols-3 gap-4 max-w-2xl mx-auto">
                <div class="rounded-2xl bg-white/10 border border-white/15 p-4">
                    ...
                    <p class="text-xs sm:text-sm text-blue-100 mt-1">Aplikasi UMKM</p>
                </div>
                <div class="rounded-2xl bg-white/10 border border-white/15 p-4">
                    <p class="text-2xl sm:text-3xl font-extrabold">7 Hari</p>
                    <p class="text-xs sm:text-sm text-blue-100 mt-1">Masa Trial</p>
                </div>
                <div class="rounded-2xl bg-white/10 border border-white/15 p-4">
                    <p class="text-2xl sm:text-3xl font-extrabold">1 Akun</p>
                    <p class="text-xs sm:text-sm text-blue-100 mt-1">Semua Aplikasi</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="aplikasi" class="py-20 bg-slate-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-12">
                <span class="text-sm font-semibold text-blue-600 uppercase tracking-wider">Katalog Aplikasi</span>
            ...
            @php
                ...
                $colors = [
                    ...
                    'toyaa'     => 'from-cyan-400 to-blue-500',
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @forelse ($apps as $app)
                    @php
                        $icon = $icons[$app->slug] ?? '📦';
                        $color = $colors[$app->slug] ?? 'from-blue-400 to-indigo-500';
                    @endphp
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition p-6 flex flex-col">
                        ...
                        @if ($app->status === 'available')
                            <a href="{{ route('register') }}" class="mt-4 w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg transition">
                                Coba Gratis 7 Hari
                            </a>
                        @else
    ...
    <section id="fitur" class="py-20 bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-12">
                <span class="text-sm font-semibold text-blue-600 uppercase tracking-wider">Kenapa megakomsel?</span>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="relative text-center">
                    <div class="mx-auto w-14 h-14 rounded-full bg-blue-600 text-white font-extrabold text-xl flex items-center justify-center shadow-lg shadow-blue-600/30">1</div>
                ...
                <div class="relative text-center">
                    <div class="mx-auto w-14 h-14 rounded-full bg-blue-600 text-white font-extrabold text-xl flex items-center justify-center shadow-lg shadow-blue-600/30">2</div>
                ...
                <div class="relative text-center">
                    <div class="mx-auto w-14 h-14 rounded-full bg-blue-600 text-white font-extrabold text-xl flex items-center justify-center shadow-lg shadow-blue-600/30">3</div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
            <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white text-center px-6 py-14">
                ...
                <div class="relative">
                    ...
                    <p class="mt-3 text-blue-100 max-w-xl mx-auto">Gabung gratis, coba aplikasi selama 7 hari, dan rasakan kemudahan mengelola bisnis dalam satu platform.</p>
                    <a href="{{ route('register') }}" class="inline-block mt-8 bg-white text-blue-700 font-bold px-10 py-4 rounded-xl hover:bg-blue-50 transition shadow-lg">
                        Daftar Gratis Sekarang →
                    </a>
                </div>
            </div>
    ...
    <footer class="bg-slate-900 text-slate-400">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-2">
                <span class="w-7 h-7 rounded-lg bg-blue-600 text-white flex items-center justify-center text-sm font-extrabold">M</span>
                <span class="font-bold text-white">megakomsel<span class="text-blue-400">.com</span></span>
            </div>
