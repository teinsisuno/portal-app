...
@section('content')
<h2 class="text-xl font-semibold text-ink mb-6">Buat Password Baru</h2>
...
<form method="POST" action="{{ route('password.store') }}" class="space-y-4">
    ...
    <div>
        <label for="password" class="block text-sm font-medium text-ink mb-1">Password Baru</label>
