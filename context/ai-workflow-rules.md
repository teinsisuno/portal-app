...
Build this project incrementally using a spec-driven workflow. Context file define what to build, how to build it, and what the current state of progress is. Always implement against these specs - do not unfer or invert behavior from scratch.
